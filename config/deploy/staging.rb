...
set :application, "Soldiers-Staging" # unique name of application
set :user, "soldiers-staging" # name of user on server
...
set :github_repo_name, "Soldiers" # name of git hub repo
