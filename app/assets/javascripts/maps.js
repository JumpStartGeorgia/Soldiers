        ...
        .enter().append("path")
          ...
          .on("mousemove", function(d,i) {
            ...
            tooltip_georgia
              ...
              .html(d["properties"]["Shape_Name_" + locale] + "<br />" + d["properties"]["count"] + "<br /><br /><span>" + gon.shape_text_from + "</span>");
          })
        ...
        .enter().append("path")
          ...
          .on("mousemove", function(d,i) {
            ...
            tooltip_afghan
              .classed("hidden", false)
              .attr("style", "left:"+(mouse[0]+25)+"px;top:"+mouse[1]+"px")
              .html(d["properties"]["Shape_Name_" + locale] + "<br />" + d["properties"]["count"] + "<br /><br /><span>" + gon.shape_text_died + "</span>");
          })
          .on("mouseout",  function(d,i) {
